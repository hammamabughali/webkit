...
/// <reference path="../src/ts/kr3m/db/mysqldbconfig.ts"/>
...
/// <reference path="../src/ts/cuboro/db.ts"/>
/// <reference path="../src/ts/cuboro/tables/trackvo.ts"/>
/// <reference path="../src/ts/cuboro/vo/track.ts"/>



var dbConfig  = kr3m.util.File.loadJsonFileSync("../bin/config/config.json");
...
function saveTrackImage(track:any, data:any, callback:Callback):void
{
    if (data.texture)
    {
        const filePath = "../bin/public/track/"+track.id+".png";
