...
{
	//Eingebaut von JanM um das iframe-autoheight-Plugin benutzen zu können,
	//da es dafür noch nichts auf https://github.com/borisyankov/DefinitelyTyped
	//gibt.
	iframeHeightExternal():any;
