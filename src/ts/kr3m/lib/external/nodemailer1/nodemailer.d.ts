...
/// <reference path="../nodemailer1/nodemailer-types.d.ts" />
/// <reference path="../nodemailer1/nodemailer-direct-transport/nodemailer-direct-transport.d.ts" />
/// <reference path="../nodemailer1/nodemailer-smtp-transport/nodemailer-smtp-transport.d.ts" />
...
declare module "nodemailer"
{
	...
	*/
	export function createTransport(
		options?: directTransport.DirectOptions): Transporter;
	/*
		Create an SMTP transporter
	*/
	export function createTransport(
		options?: smtpTransport.SmtpOptions): Transporter;
	/*
