                ...
                var innerHelper = function (j) {
                    ...
                    if (i < count) {
                        ...
                        if (counters[j] < Loop.MAX_SYNC_ITERATIONS)
                            return loopFunc(myI, innerHelpers[j]);
                        counters[j] = 0;
                        setTimeout(function () { return loopFunc(myI, innerHelpers[j]); }, 0);
                    }
...
var autoform = new kr3m.tools.autoformatter.AutoFormatter();
autoform.run();
