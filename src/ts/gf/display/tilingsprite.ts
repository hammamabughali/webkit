...
module gf.display
{
	export class TilingSprite extends PIXI.extras.TilingSprite implements gf.display.IDisplay
	{
		...
		public orgHeight:number;
		public orgWidth:number;
		public userData: any;



		constructor(game: gf.core.Game, key:
						string
						| PIXI.Texture
						| PIXI.RenderTexture, frameName?:string)
		{
			let texture: PIXI.Texture;
			if (typeof key === "string")
				texture = gf.utils.Texture.getTexture(game, <string>key, frameName);
			else
				texture = <PIXI.Texture | PIXI.RenderTexture>key;
			...
			this.orgWidth = texture.width;
			this.orgHeight = texture.height;
