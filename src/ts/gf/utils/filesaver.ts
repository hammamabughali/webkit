module gf.utils
{
	...
	{
		public static saveAs(blob, name?:string, no_auto_bom?:boolean):void
		{
			...
			let
				...
				, is_safari = /constructor/i.test(window["HTMLElement"])
				...
				, FileSaver = function (blob, name, no_auto_bom)
				{
					...
					let
						...
						{
							dispatch(filesaver, ["writestart", "progress", "write", "writeend"], event || filesaver);
						}
						...
						, fs_error = function ()
						{
							...
							{
								let opened = window.open(object_url, "_blank");
								if (!opened)
								{
